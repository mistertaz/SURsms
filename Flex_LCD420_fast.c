// https://www.ccsinfo.com/forum/viewtopic.php?t=57617&start=6
// Flex_LCD420.c
// Ttelmah 10-Dec-2018

// Flex_LCD420.c modified for faster execution speed in newer PICs
//PCM_Programmer's flex_lcd driver for 4x20
//Modified for the chip being used in this thread, and PIC24/30

// Subsequently modified for use in SONOTRONICS SMSBOX
// TAZ 10-April-2024

// commentary below was copied from the CCS 4x20 driver source.
// it describes the functions which this driver exposes for use.
// (except for lcd_getc(), we don't support that
...
////                          (Actually, go to start of next line)      ////
...
// commented out for SONOTRONICS
// symbols will be defined in a different header file
